"""
Train and evaluate the ATM-S encoder (ShallowFBCSPNet backbone) on THINGS-EEG2 via contrastive learning.

Dataset: THINGS-EEG2
Experiment: Reproducibility

Trains a subject-specific ATM-S EEG encoder using a combined contrastive loss
...
Usage:
    python Retrieval/ATMS_retrieval.py --subject sub-01
"""
import os
import sys
