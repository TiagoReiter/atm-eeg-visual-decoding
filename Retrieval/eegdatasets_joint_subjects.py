"""
PyTorch Dataset for THINGS-EEG2 supporting multi-subject joint training.

Dataset: THINGS-EEG2
Experiment: Reproducibility

Loads preprocessed EEG recordings and pre-computed ViT-H-14 CLIP image embeddings
from all subjects simultaneously for joint (pooled) training without a
leave-one-subject-out split. Used by ATMS_retrieval_joint_train.py.
Image paths are resolved via the project-level configs/thingseeg.json configuration file.
"""
import torch
...
if __name__ == "__main__":
    ...
    data_path = "./Data/Preprocessed_data_250Hz"  # override with your actual data root if needed
