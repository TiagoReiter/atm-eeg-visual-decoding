"""
PyTorch Dataset for THINGS-EEG2 with leave-one-subject-out split support (ATM-S variant).

Dataset: THINGS-EEG2
Experiment: Reproducibility

Loads preprocessed EEG recordings and pre-computed ViT-H-14 CLIP image embeddings
for the THINGS-EEG2 single-object dataset. Supports leave-one-subject-out evaluation
by excluding a specified subject from training. Image paths are resolved via the
project-level configs/thingseeg.json configuration file.
"""
import torch
