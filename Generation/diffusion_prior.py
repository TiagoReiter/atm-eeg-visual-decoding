"""
Diffusion prior model that maps EEG-derived CLIP embeddings to image-space CLIP embeddings.

Dataset: THINGS-EEG2 / Alljoined1
Experiment: Reproducibility / Generalisability

Implements a denoising diffusion model conditioned on EEG encoder output embeddings.
The prior refines noisy CLIP image embeddings iteratively, bridging the EEG-to-image gap
in Stage 2 of the two-stage visual decoding pipeline before SDXL image synthesis.
"""
import os
import torch
