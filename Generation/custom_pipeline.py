...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda') -> None:
        ...
        pipe.load_ip_adapter(
            r"C:\Users\User\.cache\huggingface\hub\models--h94--IP-Adapter\snapshots\018e402774aeeddd60609b4ecdb7e298259dc729\sdxl_models",
            subfolder=".",
            weight_name="ip-adapter_sdxl_vit-h.safetensors",  # or .safetensors if that's your file
