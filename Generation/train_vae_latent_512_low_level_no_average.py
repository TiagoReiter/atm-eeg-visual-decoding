"""
Train ATM-S encoder to predict SDXL VAE latent features from EEG signals (low-level reconstruction).

Dataset: THINGS-EEG2
Experiment: Reproducibility

Trains the ATM-S model to regress per-trial EEG recordings onto SDXL VAE latent
representations of the corresponding stimulus images without trial averaging.
Supports leave-one-subject-out cross-validation and logs metrics to Weights & Biases.

Usage:
    python Generation/train_vae_latent_512_low_level_no_average.py --subject sub-01
"""
import os
import sys
...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='./Data/Preprocessed_data_250Hz/ThingsEEG', help='Path to data')
    parser.add_argument('--output_dir', type=str, default='./Data/Output/contrast', help='Directory to save output results')
