"""
Full EEG-to-image reconstruction pipeline using the trained ATM-S model.

Dataset: THINGS-EEG2
Experiment: Reproducibility

Loads a pretrained ATM-S encoder to generate CLIP embeddings from EEG, refines them
via a diffusion prior, and synthesises images using the SDXL IP-Adapter.
Covers both high-level (CLIP-based) and low-level (VAE-based) reconstruction stages.

Usage:
    python Generation/ATMS_reconstruction.py --subject sub-01
"""
import os
import sys
...
def main():
    ...
    parser.add_argument('--project', type=str, default="Forschungspraxis-Generation", help='WandB project name')
