"""
Raw EEG preprocessing pipeline for THINGS-EEG2: epoching, channel selection, baseline correction, and MVNN normalisation.

Dataset: THINGS-EEG2
Experiment: Reproducibility

Applies channel selection, frequency downsampling, baseline correction, and multivariate
noise normalisation (MVNN) to raw THINGS-EEG2 recordings. Sorts data by image condition
and saves train/test partitions shaped as (conditions x repetitions x channels x timepoints).
...
parser.add_argument('--sub', default=8, type=int)
...
parser.add_argument('--project_dir', default='./Data/Raw/ThingsEEG', type=str, help='Path to the raw THINGS-EEG2 data directory')
