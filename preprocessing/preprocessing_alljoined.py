"""
Raw EEG preprocessing pipeline for Alljoined1: epoching, channel selection, baseline correction, and MVNN normalisation.

Dataset: Alljoined1
Experiment: Generalisability

Applies channel selection, frequency downsampling, baseline correction, and multivariate
noise normalisation (MVNN) to raw Alljoined1 EEG recordings of naturalistic NSD scenes.
Sorts data by image condition and saves train/test partitions shaped as (conditions x repetitions x channels x timepoints).
...
import argparse
from preprocessing_utils_alljoined import epoching
from preprocessing_utils_alljoined import mvnn
from preprocessing_utils_alljoined import save_prepr
...
parser.add_argument('--project_dir', default='./Data/Raw/Alljoined1', type=str, help='Path to the raw Alljoined1 data directory')
